 ...
 */
final class Version20220308105629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE games_has_users (id INT AUTO_INCREMENT NOT NULL, id_game_id INT NOT NULL, id_user_id INT NOT NULL, id_platform INT NOT NULL, INDEX IDX_C0CCCEB73A127075 (id_game_id), INDEX IDX_C0CCCEB779F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE manufacturers (id INT AUTO_INCREMENT NOT NULL, manu_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE platforms (id INT AUTO_INCREMENT NOT NULL, id_manufacturer_id INT DEFAULT NULL, model_name VARCHAR(255) NOT NULL, model_ref VARCHAR(255) NOT NULL, INDEX IDX_178186E3E37D77A5 (id_manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users_has_platforms (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, id_platform_id INT NOT NULL, INDEX IDX_3FC11CA179F37AE5 (id_user_id), INDEX IDX_3FC11CA1E7F48498 (id_platform_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE games_has_users ADD CONSTRAINT FK_C0CCCEB73A127075 FOREIGN KEY (id_game_id) REFERENCES games (id)');
        $this->addSql('ALTER TABLE games_has_users ADD CONSTRAINT FK_C0CCCEB779F37AE5 FOREIGN KEY (id_user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE platforms ADD CONSTRAINT FK_178186E3E37D77A5 FOREIGN KEY (id_manufacturer_id) REFERENCES manufacturers (id)');
        ...
        $this->addSql('ALTER TABLE users_has_platforms ADD CONSTRAINT FK_3FC11CA179F37AE5 FOREIGN KEY (id_user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE users_has_platforms ADD CONSTRAINT FK_3FC11CA1E7F48498 FOREIGN KEY (id_platform_id) REFERENCES platforms (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE games_has_users DROP FOREIGN KEY FK_C0CCCEB73A127075');
        $this->addSql('ALTER TABLE studios_has_games DROP FOREIGN KEY FK_4BE01A183A127075');
        $this->addSql('ALTER TABLE platforms DROP FOREIGN KEY FK_178186E3E37D77A5');
        $this->addSql('ALTER TABLE games_has_platforms DROP FOREIGN KEY FK_8E8E9FB4E7F48498');
        $this->addSql('ALTER TABLE users_has_platforms DROP FOREIGN KEY FK_3FC11CA1E7F48498');
        ...
        $this->addSql('ALTER TABLE games_has_users DROP FOREIGN KEY FK_C0CCCEB779F37AE5');
        $this->addSql('ALTER TABLE users_has_platforms DROP FOREIGN KEY FK_3FC11CA179F37AE5');
        $this->addSql('DROP TABLE editors');
        $this->addSql('DROP TABLE editors_has_studios');
        $this->addSql('DROP TABLE games');
        $this->addSql('DROP TABLE games_has_platforms');
        $this->addSql('DROP TABLE games_has_users');
        ...
        $this->addSql('DROP TABLE users_has_platforms');
